...
abstract class AbstractUid implements \JsonSerializable, \Stringable
{
	 ...
	 * 从以任何支持的格式表示的标识符创建一个AbstractUid
     *
	 ...
	 * 返回参数是否为AbstractUid并包含与当前实例相同的值
     */
