...
class Strings
{
	 ...
	 * 通过在$pad字符串的开头加上前缀，将UTF-8字符串填充到给定的长度。
	 ...
	 * 根据正则表达式将字符串分成数组。括号中的表达式也将被捕获并返回。
	 */
	 ...
	 * 替换所有匹配正则表达式$pattern的字符串或数组，格式为‘ pattern => replacement ’。
	 */
