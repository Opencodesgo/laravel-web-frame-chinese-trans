...
trait ReplacesAttributes
{
	 ...
	 * 替换required_if_accepted规则的所有占位符
     *
     * @param  string  $message
     * @param  string  $attribute
     * @param  string  $rule
